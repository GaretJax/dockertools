...
class Setup(object):
    ...
    @staticmethod
    def version():
        data = Setup.read(os.path.join('dockertools',
                                       '__init__.py'))
...
setup(name='docker-tools',
      ...
      package_dir={'dockertools': 'dockertools'},
      description='Different command line utilities to more easily work with Docker.',
